# GSP-ADK-GE-2026: Building & Registering an Enterprise ADK 2.0 Agent in Gemini Enterprise
...
Follow the 5 tasks sequentially to complete the lab. Each task includes a **"Check my progress"** verification script.
...
## ⚡ 2-Minute Quickstart (For Experienced Engineers)
...
# 2. Run One-Click Bootstrap (Creates BigQuery datasets/tables & Python venv)
...
To remove all BigQuery datasets, OAuth authorizations, and Cloud Run services created during this lab:
```bash
